...
db = pymysql.connect(host='localhost', user='root', password='saimysql@1445', database='ecom')
...
def cancel_order():
    ...
    #%s will directly give the input to the customer id
